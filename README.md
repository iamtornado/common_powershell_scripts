...
| **系统信息查询工具** | 功能强大的Windows系统信息查询工具，支持本地/远程查询，使用高效的基于DCOM的CIM会话，自动收集计算机名、网络配置（含DNS）、管理员组成员、用户会话等信息，支持调试模式、超时控制、自动剪切板复制和文件保存 | IT技术支持、故障诊断、资产管理、远程运维、系统监控 | 2025-08-01 | [📖 查看详情](./系统信息查询工具/README.md) |
